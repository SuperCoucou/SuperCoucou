const contractAddress = "0xa659683609a823DC261E1B96d73D949ccc8C26A3"; // Replace with your own contract address
const chain = 'goerli'; // goerli, polygon, or ethereum

const welcome_h1 = "Welcome to the SuperCoucou NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = ' SuperCoucou is an NFT collection and spreading love and kindness. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
